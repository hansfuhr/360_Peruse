...
//	$sql = "SELECT *, (/*equation here*/) AS OrderCondition FROM post WHERE /*stuff here*/ ORDER BY OrderCondition DESC LIMIT 10 OFFSET $offset";
	...
	echo "<div class=\"post\">";
	echo "<div class=\"post-contents\">";
	echo "<h3>An Interesting Title - w/ text</h3>";
	...
	echo "<div class=\"gradient\"></div>";
	echo "</div>";
	echo "<a class=\"uv\" href=\"#\">Upvote</a> / <a class=\"dv\" href=\"#\">Downvote</a><p>Posted by <a class=\"text-link\" href=\"https://ca.linkedin.com/in/daulton-baird-37004a177\">Author</a> in <a class=\"text-link\" href=\"community.html\">Lipsum</a></p>";
	echo "</div>";
	echo "</a>";
?>